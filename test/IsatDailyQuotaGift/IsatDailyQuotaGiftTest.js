...
const resetMsisdn = require('./helper/ResetMsisdnData');
const dr = require('./helper/Dr');

describe('IsatDailyQuotaGiftTest', function () {
  ...
  it('Can select quota winners from push request', async function () {
    await dr.requestPushUt2AllNumber();
    /*
