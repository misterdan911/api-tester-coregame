...
class QuizSimulatorBeta {

  constructor() {
    this.totalPlay = 0;
    this.totalRightAnswer = 0;
    this.totalPoin = 0;
    this.poinPerRightAnswer = 10;
  ...
  async run() {
    ...
    if (resBody.code == 300) { return this.getReturnData(); }
  ...
  choseAnswerId(opt) {
    ...
    arrIsTrue[1] = opt[0].is_true;
    arrIsTrue[2] = opt[1].is_true;
    arrIsTrue[3] = opt[2].is_true;
    arrIsTrue[4] = opt[3].is_true;
    ...
    if (arrIsTrue[chosenIndex] == true) {
      this.totalRightAnswer++;
      this.totalPoin += this.poinPerRightAnswer;
    }
  ...
  getReturnData() {
    let data = {
      totalPlay: this.totalPlay,
      totalRightAnswer: this.totalRightAnswer,
...
module.exports = QuizSimulatorBeta;
